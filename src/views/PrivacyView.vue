...
useHead({
  title: 'Privacy Policy | KevinMuellerDev',
  meta: [
...
<template>
  <div class="privacy-wrapper">
    ...
    <p>
      ...
      hohen Stellenwert für die Geschäftsleitung der KevinMuellerDev. Eine Nutzung der
      Internetseiten der KevinMuellerDev ist grundsätzlich ohne jede Angabe personenbezogener Daten
    ...
    <p>
      ...
      Datenschutz-Grundverordnung und in Übereinstimmung mit den für die KevinMuellerDev geltenden
    ...
    <p>
      Die KevinMuellerDev hat als für die Verarbeitung Verantwortlicher zahlreiche technische und
    ...
    <p>
      Die Datenschutzerklärung der KevinMuellerDev beruht auf den Begrifflichkeiten, die durch den
    ...
    <p>44329 Dortmund</p>
    <p>Deutschland</p>
    <p>Tel.: 015153962240</p>
    <p>E-Mail: info@kevin-mueller-dev.de</p>
    <p>Website: https://www.kevin-mueller-dev.de</p>

    <h4>3. Erfassung von allgemeinen Daten und Informationen</h4>
    <p>
      Die Internetseite der KevinMuellerDev erfasst mit jedem Aufruf der Internetseite durch eine
    ...
    <p>
      Bei der Nutzung dieser allgemeinen Daten und Informationen zieht die Sturmfest - Systemische
      Familientherapie Müller keine Rückschlüsse auf die betroffene Person. Diese Informationen
      werden vielmehr benötigt, um (1) die Inhalte unserer Internetseite korrekt auszuliefern, (2)
      ...
      erhobenen Daten und Informationen werden durch die KevinMuellerDev daher einerseits
      ...
      werden getrennt von allen durch eine betroffene Person angegebenen personenbezogenen Daten
      gespeichert.
    </p>

    <h4>4. Kontaktmöglichkeit über die Internetseite</h4>
    <p>
      Die Internetseite der KevinMuellerDev enthält aufgrund von gesetzlichen Vorschriften Angaben,
      ...
      über ein Kontaktformular den Kontakt mit dem für die Verarbeitung Verantwortlichen aufnimmt,
      werden die von der betroffenen Person übermittelten personenbezogenen Daten automatisch
      gespeichert. Solche auf freiwilliger Basis von einer betroffenen Person an den für die
    ...
    <ul style="list-style: none">
      ...
      <li>
        ...
        <p>
          ...
          von personenbezogenen Daten, die bei der KevinMuellerDev gespeichert sind, veranlassen
          möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die Verarbeitung
          Verantwortlichen wenden. Der Mitarbeiter der KevinMuellerDev wird veranlassen, dass dem
          Löschverlangen unverzüglich nachgekommen wird.
        </p>

        <p>
          Wurden die personenbezogenen Daten von der KevinMuellerDev öffentlich gemacht und ist
          unser Unternehmen als Verantwortlicher gemäß Art. 17 Abs. 1 DS-GVO zur Löschung der
          personenbezogenen Daten verpflichtet, so trifft die KevinMuellerDev unter Berücksichtigung
          ...
          erforderlich ist. Der Mitarbeiter der Sturmfest - Systemische Familientherapie Müller wird
      ...
      <li>
        ...
        <p>
          ...
          Einschränkung von personenbezogenen Daten, die bei der KevinMuellerDev gespeichert sind,
          verlangen möchte, kann sie sich hierzu jederzeit an einen Mitarbeiter des für die
          Verarbeitung Verantwortlichen wenden. Der Mitarbeiter der KevinMuellerDev wird die
      ...
      <li>
        ...
        <p>
          ...
          jederzeit an einen Mitarbeiter der KevinMuellerDev wenden.
        </p>
      </li>
      <li>
        ...
        <p>
          Die KevinMuellerDev verarbeitet die personenbezogenen Daten im Falle des Widerspruchs
        ...
        <p>
          Verarbeitet die KevinMuellerDev personenbezogene Daten, um Direktwerbung zu betreiben, so
          ...
          betroffene Person gegenüber der KevinMuellerDev der Verarbeitung für Zwecke der
          Direktwerbung, so wird die KevinMuellerDev die personenbezogenen Daten nicht mehr für
        ...
        <p>
          ...
          der Sturmfest - Systemische Familientherapie Müller zu wissenschaftlichen oder
        ...
        <p>
          ...
          Mitarbeiter der KevinMuellerDev oder einen anderen Mitarbeiter wenden. Der betroffenen
      ...
      <li>
        ...
        <p>
          ...
          ausdrücklicher Einwilligung der betroffenen Person, trifft die KevinMuellerDev angemessene
    ...
    <h4>
      7. Datenschutzbestimmungen zu Einsatz und Verwendung von Google Analytics (mit
    ...
    <p>
      ...
      Instagram integriert. Instagram ist ein Dienst, der als audiovisuelle Plattform zu
    ...
    <p>
      ...
      System der betroffenen Person automatisch durch die jeweilige Instagram-Komponente veranlasst,
      eine Darstellung der entsprechenden Komponente von Instagram herunterzuladen. Im Rahmen dieses
    ...
    <p>
      ...
      des jeweiligen Aufenthaltes auf unserer Internetseite, welche konkrete Unterseite die
      betroffene Person besucht. Diese Informationen werden durch die Instagram-Komponente gesammelt
      ...
      Instagram-Benutzerkonto der betroffenen Person zugeordnet und von Instagram gespeichert und
      verarbeitet.
    </p>
    ...
    <p>
      ...
      des Aufrufs unserer Internetseite gleichzeitig bei Instagram eingeloggt ist; dies findet
      unabhängig davon statt, ob die betroffene Person die Instagram-Komponente anklickt oder nicht.
      Ist eine derartige Übermittlung dieser Informationen an Instagram von der betroffenen Person
    ...
    <p>
      ...
      Businesskontakten ermöglicht. Über 400 Millionen registrierte Personen nutzen LinkedIn in mehr
      als 200 Ländern. Damit ist LinkedIn derzeit die größte Plattform für Businesskontakte und eine
    ...
    <p>
      ...
      (LinkedIn-Plug-In) ausgestattet ist, veranlasst diese Komponente, dass der von der betroffenen
      Person verwendete Browser eine entsprechende Darstellung der Komponente von LinkedIn
    ...
    <p>
      ...
      integrierten LinkedIn-Button, ordnet LinkedIn diese Information dem persönlichen
      LinkedIn-Benutzerkonto der betroffenen Person zu und speichert diese personenbezogenen Daten.
    </p>

    <p>
      LinkedIn erhält über die LinkedIn-Komponente immer dann eine Information darüber, dass die
      betroffene Person unsere Internetseite besucht hat, wenn die betroffene Person zum Zeitpunkt
      des Aufrufes unserer Internetseite gleichzeitig bei LinkedIn eingeloggt ist; dies findet
      unabhängig davon statt, ob die betroffene Person die LinkedIn-Komponente anklickt oder nicht.
      Ist eine derartige Übermittlung dieser Informationen an LinkedIn von der betroffenen Person
      nicht gewollt, kann diese die Übermittlung dadurch verhindern, dass sie sich vor einem Aufruf
      unserer Internetseite aus ihrem LinkedIn-Account ausloggt.
    </p>

    <p>
      LinkedIn bietet unter https://www.linkedin.com/psettings/guest-controls die Möglichkeit,
      ...
      können. Solche Cookies können unter https://www.linkedin.com/legal/cookie-policy abgelehnt
    ...
    <p>
      Die Texte des Datenschutzerklärungs-Generators wurden von
      <a href="https://dg-datenschutz.de/">Prof. Dr. h.c. Heiko Jonny Maniero</a> und Rechtsanwalt
      <a href="https://www.wbs.legal/" rel="nofollow">Christian Solmecke</a> erstellt und
      publiziert.
    </p>
  </div>
</template>
...
.privacy-wrapper {
  padding: 8rem 2rem;
  max-width: 1440px;
  color: var(--kmd-c-text-light-opacity-90);
