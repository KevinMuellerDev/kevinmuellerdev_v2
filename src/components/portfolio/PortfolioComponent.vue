...
<template>
  <section id="portfolio">
    ...
    <div class="article-container">
      <article v-for="project in portfolioData" :key="project.title">
        ...
        <div class="article-text-container">
          ...
          <div class="article-button-container">
            ...
            <ButtonTransparent v-if="project.githubUrl2" text="GitHub Backend" @click="redirectTo(project.githubUrl2)"/>
          </div>
        </div>
      </article>
    </div>
